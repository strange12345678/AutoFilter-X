...
PICS = (environ.get('PICS', 'https://graph.org/file/84811a2faa4fa5ce424e5.mp4')).split()
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/5250452a1ab5364cfc4dc.jpg")
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001940969231')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", True))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://thirankumar86:KpfFWdhOB0nh4I9F@cluster0.8q9rtk0.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "auto")
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/mighlink')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : Thiran')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001627981523')).split()]
